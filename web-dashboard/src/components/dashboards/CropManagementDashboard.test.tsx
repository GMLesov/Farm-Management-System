  ...
  describe.skip('Rendering', () => {
    it('should render dashboard with title and add button', async () => {
      renderWithProviders(<CropManagementDashboard />, {
        preloadedState: { auth: { user: mockUser, loading: false, error: null, isAuthenticated: true } },
      });
    ...
    it('should show warning when no farm is selected', () => {
      ...
      renderWithProviders(<CropManagementDashboard />, {
        preloadedState: { auth: { user: { ...mockUser, farmId: undefined }, isAuthenticated: true, loading: false, error: null } },
      });
